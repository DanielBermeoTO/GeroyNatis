...
require_once __DIR__ . '/../../Controllers/controladorProveedores.php';
...
?>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNavigation">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="../Admin/Proveedores.php"><i class="bi bi-file-person"></i> Proveedores</a>
                    </li>
                    <li class="nav-item">
  ...
  <div class="container" style="padding: 0 0 50px 0; font-family: Oswald, sans-serif;">
    ...
    <a href="../Admin/ProveedoresAñadir.php" style="font-size: 20px; color: black; text-decoration: none; padding: 15px; ">
