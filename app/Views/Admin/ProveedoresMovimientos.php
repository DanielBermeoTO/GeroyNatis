...
// Iniciar la sesión
session_start();
require_once __DIR__ . '/../../Controllers/controladorMovimiento.php'; 
...
<div class="Ordenado" style="display: flex; justify-content:center; gap: 10px; ">
    ...
    <a href="../Admin/ProveedoresMAñadir.php" style="font-size: 20px; color: black; text-decoration: none; padding: 15px; ">
